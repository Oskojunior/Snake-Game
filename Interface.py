...
class Interface:
    ...
    def game_over(self, counter):
        ...
        text_menu = self.myFont.render(
            "Press ESC to return to Main menu", True, WHITE)
    ...
    def options(self, state):
        text_snake = self.myFont.render(
            "Snake", True, self.itemcolors[self.snake_color])
        text_food = self.myFont.render(
            "Food", True, self.itemcolors[self.food_color])
        text_walls = self.myFont.render(
        ...
        if state == 0:
            ...
            self.screen.blit(
                indicator, ((screen_width / 2 - 40), (screen_height / 2 + 20)))
        self.screen.blit(
            text_food, ((screen_width/2 - 20), (screen_height/2 - 20)))
        self.screen.blit(
            text_walls, ((screen_width / 2 - 20), (screen_height / 2)))
        self.screen.blit(
            text_snake, ((screen_width / 2 - 20), (screen_height / 2 - 40)))
        self.screen.blit(
            text_background, ((screen_width / 2 - 20), (screen_height / 2 + 20)))
