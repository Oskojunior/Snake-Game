...
class Interface:
    ...
    def scoreboard(self, score):
        text = self.myFont.render("Score {0}".format(score), True, (255, 255, 255))
    ...
    def game_over(self, counter):
        ...
        text_menu = self.myFont.render("Press ESC to return to Main menu", True, (255, 255, 255))
        text = self.myFont.render("You will respawn after {0} seconds".format(counter), True, (255, 255, 255))
