...
class Interface:
    ...
    def menu(self, state):
        ...
        text_leaderboard = self.myFont.render("Leaderboard", True, WHITE)
        ...
        self.screen.blit(text_leaderboard, ((screen_width / 2 - 20), (screen_height / 2 + 20)))
    ...
    def leaderboard(self):
        text_score = self.myFont.render("Best score", True, WHITE)
        self.screen.blit(text_score, ((screen_width / 2 - 20), (screen_height / 2 - 20)))
        f = open("score.txt", "r")
        score = self.myFont.render("{0}".format(int(f.readline())), True, WHITE)
        self.screen.blit(text_score, ((screen_width / 2 - 20), (screen_height / 2 - 20)))
        self.screen.blit(score, ((screen_width / 2 - 20), (screen_height / 2)))
